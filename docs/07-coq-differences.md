...
This document describes the key architectural differences between paco-lean and the Coq paco library. Understanding these differences helps developers choose appropriate proof strategies when working with paco-lean.
